...
| إغلاق تضمينات DTS المحلي | 15 | ملفات Xiaomi Qualcomm التي يجب تحليلها قبل أي نقل Device Tree. |
| تضمينات DTS الخارجية | 14 | bindings يفترض وجودها أو تكييفها في ACK. |
