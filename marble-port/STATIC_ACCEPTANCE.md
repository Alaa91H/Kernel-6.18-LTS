...
> الفحص الحالي هو **S1–S2: static-validated**. تحذيرات DTC المتبقية البالغ عددها 130، بما فيها تحذيرات phandle في فحص القراءة بعد الدمج، تعامل كفجوات يجب حلها أو تبريرها قبل التحقق العتادي.
