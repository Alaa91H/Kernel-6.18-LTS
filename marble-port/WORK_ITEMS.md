...
|---|---|---|---|---|
| DT-001 | تكييف 15 binding مفقوداً في ACK أو تحديد بدائل upstream لها. | `researched` | تقرير `marble_dt_bindings_missing.tsv`. | كل binding يصنف: موجود بديل، منقول، أو محظور مع سبب. |
| DT-002 | نقل قاعدة `ukee.dtb` و`ukee.dtsi` وطبقة SoC cape/SM7475. | `blocked` | DT-001 وطبقة Qualcomm L1. | DTB أساسي يترجم بلا labels أو phandles مكسورة. |
